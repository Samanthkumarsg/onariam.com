    ...
    return (
        <div className='w-full fixed bottom-0 sm:bottom-0 md:top-0 lg:top-0 xl:top-0 p-6 z-50  '>
            <div className='header mt-1  max-w-screen-lg mx-auto border p-4 flex flex-row items-center justify-between rounded-3xl bg-white  z-50'>
                ...
                <div className='*:text-neutral-500 *:font-medium cursor-pointer hover:text-neutral-900 uppercase *:text-xs gap-6 tracking-wider hidden sm:hidden md:flex md:flex-row lg:flex lg:flex-row xl:flex xl:flex-row'>
