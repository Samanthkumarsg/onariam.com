...
export const CommonLayout = ({ title, text, children }) => {
  return (
    <div className='py-28 p-2  flex flex-col mb-2 items-center justify-center tracking-wide nset-0 bg-[radial-gradient(#f5f5f5_1px,transparent_1px)] [background-size:8px_8px] '>
